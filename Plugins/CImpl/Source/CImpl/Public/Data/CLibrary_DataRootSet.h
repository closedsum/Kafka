...
namespace NCDataRootSet
{
	...
	*/
	...
	public:
		...
		* return
		*/
		static const FCDataRootSet* GetSafe(const FString& Context, const UObject* WorldContext);
		...
		* return				
		*/
		static const FCDataRootSet& GetChecked(const FString& Context, const UGameInstance* GameInstance);
		...
		* return				
		*/
		static const FCDataRootSet& GetChecked(const FString& Context, const UObject* WorldContext);
	...
	#define MemberType FCDataRootSet::EMember
		...
		*/
		...
		FORCEINLINE static RowStructType* GetSafeDataTableRow(const FString& Context, const UObject* WorldContext, const MemberType& Member, const FName& RowName, void(*Log)(const FString&) = &FCLog::Warning)
		{
		...
		*/
		static bool GetSafeDataTablePath(const FString& Context, const UObject* WorldContext, const MemberType& Member, FString& OutPath, void(*Log)(const FString&) = &FCLog::Warning);

		/**
		* Load the DataTable and ALL Rows associated with Member.
		* 
		* @param Context		The calling context
		* @param WorldContext	Object that has reference to a World (GetWorld() is Valid).
		* @param Member			The DataTable member.
		* return				DataTable
		*/
		static UDataTable* LoadDataTableAndAllRowsChecked(const FString& Context, const UObject* WorldContext, const MemberType& Member);
